...
//
//     final paymentsUpdateModel = paymentsUpdateModelFromJson(jsonString);

import 'dart:convert';

PaymentsUpdateModel paymentsUpdateModelFromJson(String str) =>
    PaymentsUpdateModel.fromJson(json.decode(str));

String paymentsUpdateModelToJson(PaymentsUpdateModel data) =>
    json.encode(data.toJson());

class PaymentsUpdateModel {
  bool? result;
  PaymentsUpdateModelData? data;
  ...
  factory PaymentsUpdateModel.fromJson(Map<String, dynamic> json) =>
      PaymentsUpdateModel(
        result: json["result"],
        pricingPlanId: json["pricing_plan_id"],
        data: json["data"] == null
            ? null
            : PaymentsUpdateModelData.fromJson(json["data"]),
      );
...
class PaymentsUpdateModelData {
  PurpleSubscription? subscription;
  int? totalCredits;

  PaymentsUpdateModelData({
    this.subscription,
    this.totalCredits,
  });

  factory PaymentsUpdateModelData.fromJson(Map<String, dynamic> json) =>
      PaymentsUpdateModelData(
