...
class GeneralAnswer extends StatefulWidget {
  const GeneralAnswer({
    Key? key,
  ...
  @override
  State<GeneralAnswer> createState() => _GeneralAnswerState();
}

class _GeneralAnswerState extends State<GeneralAnswer> {
  @override
  Widget build(BuildContext context) {
    var zeminModel = Provider.of<ZeminViewModel>(context);

    return Dismissible(
      key: Key(widget.contents), // Benzersiz bir key kullanın
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  //widget silme işlemi burada yapılacak
                },
                child: Padding(
                  padding: const EdgeInsets.all(4.0),
                  child: SvgPicture.asset(
