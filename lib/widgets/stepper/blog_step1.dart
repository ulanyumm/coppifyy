...
class BlogStep1 extends StatefulWidget {
  const BlogStep1({
    super.key,
  });

  @override
  State<BlogStep1> createState() => _BlogStep1State();
}

class _BlogStep1State extends State<BlogStep1> {
      ...
      child: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          AnimatedContainer(
            ...
            width: double.infinity,
            height:
                selectedDrafts ? MediaQuery.of(context).size.height * 0.3 : 0,
